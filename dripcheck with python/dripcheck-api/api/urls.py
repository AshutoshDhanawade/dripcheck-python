...
urlpatterns = [
    ...
    path('wardrobe/', WardrobeListCreateView.as_view(), name='wardrobe-list-create'),

    path('wardrobe/<str:item_id>', WardrobeDetailView.as_view(), name='wardrobe-detail'),

    # ── User Profile ──────────────────────────────────────────────────────────
    path('users/', UserProfileDetailView.as_view(), name='user-profile'),

    # ── Analytics ─────────────────────────────────────────────────────────────
    path('analytics/', AnalyticsView.as_view(), name='analytics'),

    # ── Wear Log ──────────────────────────────────────────────────────────────
    path('wearlog/', WearLogView.as_view(), name='wearlog'),

    # ── Bundle Generation (converted from FastAPI → DRF) ──────────────────────
    path('bundles/', BundleListView.as_view(), name='bundles'),
    path('bundles/save', SaveBundleView.as_view(), name='save-bundle'),
